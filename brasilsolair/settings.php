 ...
 */
 if (preg_match("/^(127\.0\.0|192\.168\.0).(.*)$/", $_SERVER['SERVER_ADDR'])) {
	$db_url = 'mysql://root:root@localhost/brasils4_brasilSolair';
	$db_prefix = '';

}else{
	
	$db_url = 'mysql://brasils4_uSolair:9i[KZ6daa5HE@localhost/brasils4_brasilSolair';
	$db_prefix = '';

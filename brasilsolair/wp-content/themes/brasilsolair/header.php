...
<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri() ?>/assets/libs/font-awesome/css/font-awesome.min.css">
...
<script type="text/javascript" src="<?php echo get_template_directory_uri() ?>/assets/libs/parallax.min.js"></script>

<div class="panel panel-default">
  <div class="panel-heading noPaddingL">
    <h4 class="panel-title text-left"><a href="#collapse-voucher" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle"><?php echo $heading_title; ?> <i class="fa fa-caret-down"></i></a></h4>
  </div>

...
$sql = 'SELECT * FROM oc_order WHERE order_id = "'.$oid.'"';
...
if ($result->num_rows > 0) {
      ...
      $x = $row['payment_custom_field'];
      $y = $row['shipping_custom_field'];
      }
  ...
  <div class="row"><?php /* echo $column_left; */?>
    ...
    <?php echo $content_top; ?>
      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody>
          <tr>
            <td class="text-left"><?php echo str_replace("{complemento}",$complemento,str_replace("{number}",$number,$payment_address)); ?></td>
            <?php if ($shipping_address) { ?>
            <td class="text-left"><?php echo str_replace("{complemento}",$complemento,str_replace("{number}",$number,$shipping_address)); ?></td>
            <?php } ?>
          </tr>
        </tbody>
      </table>

...
<div class="container">
  ...
  <div class="row"><?php /* echo $column_left; */?>
    ...
    <div id="content" class="col-sm-12 mbottom">
          ...
          <div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
            ...
            <div class="col-sm-10">
              ...
              <div class="input-group date">
                ...
                <input type="text" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo (isset($register_custom_field[$custom_field['custom_field_id']]) ? $register_custom_field[$custom_field['custom_field_id']] : $custom_field['value']); ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="DD/MM/YYYY" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control dateMask" />
        ...
        <fieldset id="address">
         ...
         <div class="form-group hide">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" name="company" value="0" placeholder="<?php echo $entry_company; ?>" id="input-company" class="form-control" />
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <input required type="text" name="address_2" value="<?php echo $address_2; ?>" placeholder="<?php echo $entry_address_2; ?>" id="input-address-2" class="form-control" />
          ...
          <div class="form-group required"  data-sort="99">
...
$(document).ready(function(){
  ...
  setTimeout(function(){
    ...
    $('input[placeholder=CPF]').mask('000.000.000-00');

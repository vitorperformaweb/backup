    ...
    <div class="form-horizontal">
      ...
      <div id="form" class="col-sm-7">
        ...
        <div class="form-group col-sm-12">
          ...
          <div class="col-sm-9">
            <input class="form-control" type="month" id="validade" name="validade" placeholder="Ex: 12/2015" />
          </div>
        </div>
        ...
        <div class="form-group col-sm-12">
          ...
          <div class="col-sm-9">
            <input class="form-control" type="number" id="cvv" name="cvv" placeholder="Ex: 123 ou 1234" />
          </div>
        </div>

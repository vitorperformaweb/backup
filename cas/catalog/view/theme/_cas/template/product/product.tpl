        ...
        <div class="<?php echo $class; ?>">
          ...
          <div id="product">
           ...
           <!--  <?php if( $t == 0){?>
            ...
            <div class="form-group">
              ...
              <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-transparent btn-block">Adicionar à sacola</button>
            </div>
            <!-- <?php if ($minimum > 1) { ?>
          ...
          <ul class="nav nav-tabs">
            ...
            <?php if ($review_status) { ?>
              ...
              <li><a href="#tab-review" data-toggle="modal" data-target="#myModal">Tamanhos</a></li>
              <?php } ?>
            <?php } ?>
          </ul>
...
$( document ).on( "mousemove", function( event ) {
  if(
    event.pageX > ($('.stage').offset().left + 30) && 
    event.pageX < ($('.stage').offset().left + (l - 30)) && 
    event.pageY > $('.stage').offset().top && 
    event.pageY < ( $('.stage').offset().top + a) ){
...
$('.colorSwitcher input[type=radio]').each(function(a,b){
  if($(this).is(':checked')){
...
$('.genderSwitcher input[type=radio]').each(function(a,b){
  if($(this).is(':checked')){
    $(this).parent().addClass('checked');
  }else{
    $(this).parent().removeClass('checked');

	...
	public function index() {
		...
		$this->load->language('product/product');
			...
			if ($this->customer->isLogged()){
				...
				$data['customer_fax'] = $this->customer->getFax();
			}else{
				$data['loggeds'] = false;
			}
		...
		if ($product_info) {
			...
			if ($product_info['image']) {
				...
				$data['zoom'] = $this->model_tool_image->resize($product_info['image'],1200,1200);
			...
			$m = 'SELECT * FROM oc_modal WHERE productId="'.$this->request->get['product_id'].'"';

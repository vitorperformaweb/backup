...
class ControllerAccountAddress extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('account/address&return=cart', '', 'SSL'));
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$replace = array(
				...
				'number' 		=> $result['custom_field'][1],

				'complemento' 	=> $result['custom_field'][4],
			...
			// print_r($result['custom_field']);

			// exit();



			// $data['custom_fields'] = $result['custom_field'];

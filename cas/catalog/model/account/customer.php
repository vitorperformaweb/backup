...
class ModelAccountCustomer extends Model {
	...
	<tr>
		<td align="center">
			<p style="font-family: Tahoma,Verdana,Segoe,sans-serif; font-size: 17px; color: #313131; margin-bottom:20px">Olá, <span style="color: #313131">'.$this->request->post["firstname"].'</span>,</p>
			<p style="font-family: Tahoma,Verdana,Segoe,sans-serif; font-size: 17px; color: #313131; margin-bottom:20px">Seu cadastro foi concluído com sucesso!</p>
			<p style="font-family: Tahoma,Verdana,Segoe,sans-serif; font-size: 17px; color: #313131; margin-bottom:20px">Clique no link para acessar sua conta:  <a href="'.$this->url->link('account/login', '', 'SSL').'" style="color: #313131">'.$this->url->link('account/login', '', 'SSL').'</a></p>

			<p style="font-family: Tahoma,Verdana,Segoe,sans-serif; font-size: 17px; color: #313131; margin-bottom:20px; margin-top: 32px;">Atenciosamente, equipe CAS PLUS WATER.</p>
		</td>
	</tr>
	<tr>
		<td>
			<a href="http://caspluswater.com"><img src="http://caspluswater.com/emails/imagens/confirmacaoCadastro_03.png" width="650" height="270" alt=""></a>
		</td>
	</tr>
	<tr>
		<td>
			<a href="http://caspluswater.com"><img src="http://caspluswater.com/emails/imagens/confirmacaoCadastro_04.png" width="650" height="94" alt=""></a>
		</td>
	</tr>
</table>';

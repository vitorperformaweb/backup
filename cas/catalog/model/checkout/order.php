	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false) {
		...
		if ($order_info) {
			...
			if (!$order_info['order_status_id'] && $order_status_id) {
				...
				//////////CAMPOS CUSTOMIZADOS
				$getCustomField = $this->db->query("SELECT * FROM oc_order WHERE order_id ='".$order_id."'");
				$customFields = unserialize($getCustomField->row['payment_custom_field']);
				$data['firstname'] = $getCustomField->row['firstname'];

				// print_r($getCustomField->row['firstname']);
				//  exit();
				...
				$replace = array(
					...
					'number'	=> $customFields[1],
					'complemento' => $customFields[4],
			...
			if ($order_info['order_status_id'] && $order_status_id) {
				...
				$message = '<table id="Tabela_01" width="650" height="650" border="0" cellpadding="0" cellspacing="0" align="center">
					<tr>
						<td align="center">
							<p style="font-family: Tahoma,Verdana,Segoe,sans-serif; font-size: 17px; color: #313131; margin-bottom:20px">
							Olá, <span style="color: #313131">' . $order_info["firstname"] . '</span>, 
							</p>

							<p style="font-family: Tahoma,Verdana,Segoe,sans-serif; font-size: 17px; color: #313131; margin-bottom:20px">Seu pedido <span style="color: #313131">' .$order_id. '</span> teve o status alterado para: "Processando"</p>
							...
							<p style="font-family: Tahoma,Verdana,Segoe,sans-serif; font-size: 17px; color: #313131; margin-bottom:20px">Obrigado!</p>	
						</td>
					</tr>
					<tr>
						<td>
							<img src="http://caspluswater.com/emails/imagens/confirmacaoEnvio_03.jpg" width="650" height="201" alt=""></td>
					</tr>
					<tr>
						<td align="center">
							<p style="font-family: Tahoma,Verdana,Segoe,sans-serif; font-size: 17px; color: #313131; margin-bottom:35px; margin-top:35px">Clique no link para acompanhar seu pedido:
							<a href="'.$order_info["store_url"] . 'index.php?route=account/order/info&order_id=' . $order_id .'" style="color: #313131"> '.$order_info["store_url"] . 'index.php?route=account/order/info&order_id=' . $order_id .'</span></p>
						</td>
					</tr>
					<tr>
						<td>
							<img src="http://caspluswater.com/emails/imagens/confirmacaoEnvio_05.jpg" width="650" height="94" alt=""></td>
					</tr>
				</table>';

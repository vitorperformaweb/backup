<?php
/**
 * Plugin Name: birkita: Masonry Module
 ...
 */
add_action('widgets_init', 'birkita_register_masonry_module');

function birkita_register_masonry_module(){
	register_widget('birkita_masonry');
}
 ...
 *
 */ 
class birkita_masonry extends WP_Widget {
	...
	function __construct(){
		/* Widget settings. */	
		$widget_ops = array('classname' => 'module-masonry', 'description' => esc_html__('[Full-width module][Content module] Displays posts with masonry layout in content section.', 'birkita'));
		
		/* Create the widget. */
		parent::__construct('birkita_masonry', esc_html__('*birkita: Module Masonry', 'birkita'), $widget_ops);
	}
        ...
        <div id="<?php echo esc_attr($uid);?>" class="module-masonry-wrapper clear-fix">
            <div class="masonry-content-container">
                <?php while ( $query -> have_posts() ) : $query -> the_post(); ?>
                    <?php echo birkita_masonry_render(get_the_ID());?>
                <?php endwhile;?>
            </div>	

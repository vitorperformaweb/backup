<?php
/**
 * Plugin Name: birkita: Module Post Four
 ...
 */
add_action('widgets_init', 'birkita_register_module_post_four');

function birkita_register_module_post_four(){
	register_widget('birkita_module_post_four');
}
 ...
 *
 */ 
class birkita_module_post_four extends WP_Widget {
	...
	function __construct(){
		/* Widget settings. */	
		$widget_ops = array('classname' => 'module-post-four', 'description' => esc_html__('[Full-width module][Content module] Displays one main posts on left side and list of four posts on right side in fullwidth and content section', 'birkita'));
		
		/* Create the widget. */
		parent::__construct('birkita_module_post_four', esc_html__('*birkita: Module Posts Four', 'birkita'), $widget_ops);
	}
                        ...
                        <div class="post-info">
                            ...
                            <div class="entry-excerpt">
                                <?php 
                                    ...
                                    echo birkita_the_excerpt_limit($string, 20); 
                                ?>
                            </div>

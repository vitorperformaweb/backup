<?php
/**
 * Plugin Name: birkita: Classic Blog Module
 ...
 */
add_action('widgets_init', 'birkita_register_classic_blog_module');

function birkita_register_classic_blog_module(){
	register_widget('birkita_classic_blog');
}
 ...
 *
 */ 
class birkita_classic_blog extends WP_Widget {
	...
	function __construct(){
		/* Widget settings. */	
		$widget_ops = array('classname' => 'module-classic-blog', 'description' => esc_html__('[Full-width module][Content module] Displays latest posts in classic blog layout in content section.','birkita'));
		
		/* Create the widget. */
		parent::__construct('birkita_classic_blog', esc_html__('*birkita: Module Classic Blog','birkita'), $widget_ops);
	}
	...
	function widget($args, $instance){	
        ...
        <div id="<?php echo esc_attr($uid);?>" class="birkita_classic-blog-wrapper layout1" >
         	
    		<div class="classic-blog-content-container">
                <?php while ( $query -> have_posts() ) : $query -> the_post(); ?>
                    <?php $post_id = get_the_ID();?>
                    <?php echo birkita_classic_blog_render($post_id, $excerpt_length);?>
                <?php endwhile;?>
            </div>	

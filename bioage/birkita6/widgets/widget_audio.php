<?php
/**
 * Plugin Name: birkita: Audio Posts Widget
 ...
 */
add_action('widgets_init', 'birkita_register_audio_widget');

function birkita_register_audio_widget(){
	register_widget('birkita_audio');
}
 ...
 *
 */ 
class birkita_audio extends WP_Widget {
	...
	function __construct(){
		/* Widget settings. */	
		$widget_ops = array('classname' => 'widget-audio', 'description' => esc_html__('[Sidebar widget] Displays a List of Audio Posts in sidebar.', 'birkita'));
		
		/* Create the widget. */
		parent::__construct('birkita_audio', esc_html__('*birkita: Widget Audio','birkita'), $widget_ops);
	}

<?php
/**
 * Plugin Name: birkita: Module Post Four Row
 * Plugin URI: http://demo.monotheme.info/birkita/
 * Description: This module displays one main posts above and list of four posts below in 2 rows
 * Version: 1.0
 * Author: birkita
 ...
 */
add_action('widgets_init', 'birkita_register_module_post_four_row');

function birkita_register_module_post_four_row(){
	register_widget('birkita_module_post_four_row');
}
 ...
 *
 */ 
class birkita_module_post_four_row extends WP_Widget {
	...
	function __construct(){
		/* Widget settings. */	
		$widget_ops = array('classname' => 'module-post-four module-post-four-row', 'description' => esc_html__('[Content module] Displays one main posts above and list of four posts below in 2 rows', 'birkita'));
		
		/* Create the widget. */
		parent::__construct('birkita_module_post_four_row', esc_html__('*birkita: Module Posts Four Row', 'birkita'), $widget_ops);
	}

<?php
/**
 * Plugin Name: birkita: Slider Widget
 ...
 */
add_action('widgets_init', 'birkita_register_slider_widget');

function birkita_register_slider_widget(){
	register_widget('birkita_slider');
}
 ...
 *
 */ 
class birkita_slider extends WP_Widget {
	...
	function __construct(){
		/* Widget settings. */	
		$widget_ops = array('classname' => 'widget-slider', 'description' => esc_html__('[Sidebar widget] Displays a slider in sidebar.', 'birkita'));
		
		/* Create the widget. */
		parent::__construct('birkita_slider', esc_html__('*birkita: Widget Slider','birkita'), $widget_ops);
	}

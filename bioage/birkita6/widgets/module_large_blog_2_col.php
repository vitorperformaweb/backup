<?php
/**
 * Plugin Name: birkita: Large Blog Module 2 Columns
 ...
 */
add_action('widgets_init', 'birkita_register_large_blog_2_module');

function birkita_register_large_blog_2_module(){
	register_widget('birkita_large_blog_2');
}
 ...
 *
 */ 
class birkita_large_blog_2 extends WP_Widget {
	...
	function __construct(){
		/* Widget settings. */	
		$widget_ops = array('classname' => 'module-large-blog module-large-blog-2', 'description' => esc_html__('[Full-width module] Displays latest posts in large blog layout in content section.','birkita'));
		
		/* Create the widget. */
		parent::__construct('birkita_large_blog_2', esc_html__('*birkita: Module Large Blog 2 Columns','birkita'), $widget_ops);
	}

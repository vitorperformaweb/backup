	...
	<?php while ( $r->have_posts() ) : $r->the_post(); ?>
		<li<?php 
			...
			if ( ! $hide_title ) {
				?>
			<div class="infos">
				<span class="rpwwt-post-title"><?php if ( $post_title = $this->get_the_trimmed_post_title( $post_title_length ) ) { echo $post_title; } else { the_ID(); } ?></span>
				<div class="rpwwt-post-date"><?php echo get_the_date(); ?></div>
			</div>
			<?php
			}
			?></a><?php 
